...
const alert = '#d2531c'
const green = '#61bd4f'
const green10 = '#008555'
const background = '#162447'
const blue = '#026aa7'
const blueLight = '#4e97c2'
const blueLightBright = '#3d99ce'
const purple = '#a86cc1'
const purpleLight = '#cd8de5'
const darKblue = '#1B1B2F'
// color aliases
const primary = blue
const secondary = gray90
const text = white
const success = green
const error = red
...
// https://coolors.co/4357ad-48a9a6-e4dfda-d4b483-c1666b